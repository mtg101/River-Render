...
PRINT_HL_STRING_AT_Y_X:

PRINT_HL_STRING_AT_Y_X_LOOP:
	; next char
	LD		A, (HL)

	CP		0								; is it 0null terminator?
	JP		Z,  PRINT_HL_STRING_AT_Y_X_DONE
	...
	JP		PRINT_HL_STRING_AT_Y_X_LOOP

PRINT_HL_STRING_AT_Y_X_DONE:
